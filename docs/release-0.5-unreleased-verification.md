...
terms proposal helper. It is intentionally not a release checklist yet. The goal
is to preserve the consumer proof and make clear that no additional ability
batch should start without a concrete workflow gap.
