...
`magick-ai-abilities` 0.2 release candidate. It does not create a tag or publish
a release.
...
| `composer check:boundary` | Pass | `magick-ai-abilities project boundary: ok`. |
...
files from `magick-ai-abilities`.
