...
| Diagnostics | `magick-ai-abilities/wp-diagnostics-summary`, `magick-ai-abilities/wp-ops-diagnostics-detail`, `magick-ai/site-info`, `magick-ai/get-site-operations-dashboard` | Redacted WordPress-only diagnostics are useful outside Magick AI. | Any Magick AI/MCP/runtime diagnosis stays in the host. |
