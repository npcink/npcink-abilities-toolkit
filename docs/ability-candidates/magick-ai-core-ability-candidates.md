...
| Metadata planning | `magick-ai/resolve-post-metadata-plan`, future tag/category proposal helpers | WordPress taxonomy and metadata plans can be schema-first proposal helpers. | Validate editorial policy and commit taxonomy/meta writes. |
