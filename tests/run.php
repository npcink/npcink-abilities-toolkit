...
npcink_abilities_toolkit_assert_same( 'ready_for_core_handoff_after_visual_check', $media_alt_caption_review_set['data']['selected_items'][0]['automation_recommendation'] ?? '', 'media ALT/caption review set exposes machine-readable automation guidance without write authority' );
npcink_abilities_toolkit_assert_same( 1, $media_alt_caption_review_set['data']['eligibility_summary']['ready_for_handoff_count'] ?? null, 'media ALT/caption review set summarizes ready rows for UI triage' );
