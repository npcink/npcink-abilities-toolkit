...
final class Core_Read_Pack_Classifier {
	...
	public static function known_pack_map() {
			...
			'magick-ai/get-test-content-inventory'              => 'content_operations',
			'magick-ai/build-test-content-cleanup-plan'         => 'content_operations',
			'magick-ai/build-content-inventory-fix-plan'        => 'content_operations',
			...
			'magick-ai/get-internal-link-graph-health'          => 'seo_geo_support',
				...
				'magick-ai/list-media-backups'                      => 'media_governance',
				'magick-ai/build-media-inventory-fix-plan'          => 'media_governance',
