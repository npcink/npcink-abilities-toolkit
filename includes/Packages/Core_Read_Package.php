	 ...
	 */
		public function definitions() {
			...
			'magick-ai/build-media-rename-plan' => array(
				...
				'description'      => __( 'Builds a read-only one-attachment rename plan for a reviewed target media file name without mutating WordPress.', 'npcink-abilities-toolkit' ),
				'category'         => 'magick-ai-data',
				'capability'       => 'upload_files',
				'required_scope'   => 'media.read',
				'required_scopes'  => array( 'media.read' ),
