	 ...
	 */
		public function definitions() {
			...
			'magick-ai/build-media-derivative-batch-plan' => array(
				'label'            => __( 'Build Media Derivative Batch Plan', 'magick-ai-abilities' ),
				'description'      => __( 'Builds a bounded read-only plan for batch Cloud media derivative previews from local media filters without calling Cloud, creating proposals, or mutating WordPress.', 'magick-ai-abilities' ),
				'category'         => 'magick-ai-data',
				'capability'       => 'upload_files',
				'required_scope'   => 'media.read',
				'required_scopes'  => array( 'media.read' ),
