		...
		return array(
			'magick-ai-abilities/wp-diagnostics-summary' => array(
				...
				'input_schema'     => array(
					...
					'properties'           => array(
						...
						'include_current_user'   => array( 'type' => 'boolean', 'default' => true ),
			...
			'magick-ai-abilities/wp-ops-diagnostics-detail' => array(
				...
				'input_schema'     => array(
					...
					'properties'           => array(
						'include_plugins'        => array( 'type' => 'boolean', 'default' => true ),
						'include_active_plugins' => array( 'type' => 'boolean', 'default' => true ),
						'include_inactive_plugins' => array( 'type' => 'boolean', 'default' => false ),
						'include_plugin_updates' => array( 'type' => 'boolean', 'default' => true ),
						'include_must_use_plugins' => array( 'type' => 'boolean', 'default' => true ),
						'include_dropins'        => array( 'type' => 'boolean', 'default' => true ),
						...
						'include_database'       => array( 'type' => 'boolean', 'default' => true ),
						'include_cron_events'    => array( 'type' => 'boolean', 'default' => true ),
						'max_cron_events'        => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 50, 'default' => 20 ),
						'include_error_log'      => array( 'type' => 'boolean', 'default' => true ),
						...
						'include_content_types'  => array( 'type' => 'boolean', 'default' => true ),
						'include_roles'          => array( 'type' => 'boolean', 'default' => true ),
						'include_widgets'        => array( 'type' => 'boolean', 'default' => true ),
						'include_block_theme'    => array( 'type' => 'boolean', 'default' => true ),
						'include_search'         => array( 'type' => 'boolean', 'default' => true ),
						'include_integrations'   => array( 'type' => 'boolean', 'default' => true ),
				...
				'output_schema'    => array(
					...
					'required'   => array( 'detail_version', 'generated_at', 'redacted', 'plugins', 'current_user', 'php', 'object_cache', 'rewrite', 'https', 'server', 'database', 'cron_events', 'error_log', 'content_types', 'roles', 'widgets', 'block_theme', 'search', 'integrations', 'seo_summary', 'security_summary', 'performance_summary', 'omitted' ),
				),
