	...
	public static function definitions( $callbacks ) {
		return array(
			...
			'magick-ai/search-posts'    => array(
				...
				'description'      => __( 'Searches local WordPress posts by keyword and bounded filters, returning matching post summaries.', 'magick-ai-abilities' ),
				'category'         => 'magick-ai-data',
				'capability'       => 'edit_posts',
				'contract_version' => 'v1',
				'source'           => 'official',
			...
			'magick-ai/search-post-meta' => array(
				'label'            => __( 'Search Post Meta', 'magick-ai-abilities' ),
				'description'      => __( 'Searches explicitly named local post meta keys and returns bounded matching post summaries without writing.', 'magick-ai-abilities' ),
				'category'         => 'magick-ai-data',
				'capability'       => 'edit_posts',
				'contract_version' => 'v1',
				'source'           => 'official',
				'input_schema'     => array(
					...
					'properties'           => array(
						...
						'match'     => array( 'type' => 'string', 'enum' => array( 'contains', 'exact' ), 'default' => 'contains' ),
						'post_type' => array( 'type' => 'string', 'default' => 'post' ),
						'post_types' => array(
							'type'  => 'array',
							'items' => array( 'type' => 'string' ),
					...
					'required'             => array( 'search', 'meta_keys' ),
					'additionalProperties' => false,
				),
				'output_schema'    => array(
					'type'       => 'object',
					'properties' => array(
						...
						'items'    => array(
							...
							'items' => array(
								...
								'required'   => array( 'id', 'title', 'status', 'matched_meta_keys' ),
							),
						),
					),
					'required'   => array( 'total', 'items' ),
