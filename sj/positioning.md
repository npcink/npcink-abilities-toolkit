# Magick AI Abilities Positioning

## English

Magick AI Abilities is the ability content package and contract specification
...
Magick AI Abilities is part of the Magick AI plugin family:
...
Magick AI Abilities 是 WordPress Abilities API 生态中的能力内容包和合约规范层。
...
Magick AI Abilities 是 Magick AI 系列插件的一部分：
